...
public class provaaaSerializer {
    ...
    public static class M3 {
        ...
        public static cat.ogasoft.protocolizer.messages.provaaa.M3 buildM3(cat.ogasoft.examples.Test1.M3 target){
            ...
            if(target.getProva() != null){
                builder.setProva(cat.ogasoft.protocolizer.dumppers.serializers.provaaaSerializer.M2.buildM2(target.getProva()));
            }
            return builder.build();
        }
    }
    ...
    public static class M2 {
        ...
        public static cat.ogasoft.protocolizer.messages.provaaa.M2 buildM2(cat.ogasoft.examples.Test1.M2 target){
            ...
            if(target.getM1() != null){
                builder.setM1(cat.ogasoft.protocolizer.dumppers.serializers.provaaaSerializer.M1.buildM1(target.getM1()));
            }
            if(target.getM3() != null){
                builder.setM3(cat.ogasoft.protocolizer.dumppers.serializers.provaaaSerializer.M3.buildM3(target.getM3()));
            }
            if(target.getM2() != null){
                builder.setOk(cat.ogasoft.protocolizer.dumppers.serializers.provaaaSerializer.M3.buildM3(target.getM2()));
            }
            return builder.build();
        }
    }
